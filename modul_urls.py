...
def is_url_safe_drweb(url: str):
    ...
    for attempt in range(3):
        r = requests.post("https://online.drweb.com/result/", data={"url": url}, headers={"User-Agent":"Mozilla/5.0","Referer":"https://online.drweb.com/"}, timeout=45)
        break

    html = r.text.lower()
    if "нерекоменд" in html or "unwanted" in html:
        return False
